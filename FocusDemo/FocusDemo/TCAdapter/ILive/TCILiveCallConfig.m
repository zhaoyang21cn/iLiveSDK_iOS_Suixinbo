...
@implementation TCILiveCallRoomEngine

- (void)setRuntimeConfig:(TCILiveCallConfig *)runtimeConfig
{
    if (_runtimeConfig)
    {
...
@implementation TCILiveCallViewController
...
- (void)createRoomEngine
{
    if (_runtimeConfig)
    {
        if (!_roomEngine)
        {
            ...
            TCILiveCallRoomEngine *re = [[TCILiveCallRoomEngine alloc] initWith:(id<IMHostAble, AVUserAble>)_currentUser enableChat:_enableIM];
